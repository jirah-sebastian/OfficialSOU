...
class OrganizationApplicationFormController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.organizationApplicationForms.index', compact('organizationApplicationForms'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.organizationApplicationForms.create', compact('organizations'));
    }
    ...
    public function store(StoreOrganizationApplicationFormRequest $request)
    {
        ...
        return redirect()->route('admin.organization-application-forms.index');
    }
    ...
    public function edit(OrganizationApplicationForm $organizationApplicationForm)
    {
        ...
        return view('admin.organizationApplicationForms.edit', compact('organizationApplicationForm', 'organizations'));
    }
    ...
    public function show(OrganizationApplicationForm $organizationApplicationForm)
    {
        ...
        return view('admin.organizationApplicationForms.show', compact('organizationApplicationForm'));
    }
