...
class SoRegistrationApplicationNotification extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Confirmation of Membership Application Submission',
        );
    }
    ...
    {
        return new Content(
            view: 'mail.v2.so-registration-application-notification',
            with: [
