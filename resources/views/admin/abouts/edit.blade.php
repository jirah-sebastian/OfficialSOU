    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.abouts.update", [$about->id]) }}" enctype="multipart/form-data">
            ...
            {{-- <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('side_view_content') ? 'is-invalid' : '' }}" name="side_view_content" id="side_view_content">{!! old('side_view_content', $about->side_view_content) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('main_content') ? 'is-invalid' : '' }}" name="main_content" id="main_content">{!! old('main_content', $about->main_content) !!}</textarea>
