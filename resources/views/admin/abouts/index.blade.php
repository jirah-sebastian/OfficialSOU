...
@can('about_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-warning" href="{{ route('admin.abouts.create') }}">
                <i class="fas fa-plus-circle"></i><b> {{ trans('global.add') }} {{ trans('cruds.about.title_singular') }} </b>
            </a>
        </div>
    </div>
@endcan
            ...
            <table class=" table table-bordered table-striped table-hover "> 
                ...
                <thead>
                    <tr>
                        ...
                        <!-- Commented out the th for actions -->
                        {{-- <th>
                ...
                <tbody>
                    @foreach($abouts as $key => $about)
                        <tr data-entry-id="{{ $about->id }}">
                            ...
                            <!-- Commented out the td for actions -->
                            {{-- <td>
                                @can('about_show')
