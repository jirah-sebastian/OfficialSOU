...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form id="annForm" method="POST" action="{{ route('admin.announcements.store') }}" enctype="multipart/form-data">
                @csrf
    ...
    <script>
            ...
            init: function() {
                ...
                $('form').submit(function(event) {
                    ...
                    if (myDropzone.getQueuedFiles().length === 0 && myDropzone.getAcceptedFiles().length ===
                        ...
                        $('#photo-dropzone').parent().append(errorMessage);
                        ...
                        $('html, body').animate({
                            scrollTop: $("#photo-dropzone").offset().top
                        }, 100);
                    } else {
                        // Check if there are any other validation errors
                        var otherValidationErrors = $('.text-danger').not('#photo-dropzone')
                            .length > 0;
        ...
        $(document).ready(function() {
            ...
            $('#confirmSubmit').click(function() {
                ...
                $('#annForm').off('submit').submit(); // Submit the form
            });
