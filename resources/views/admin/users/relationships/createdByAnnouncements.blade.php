    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-createdByAnnouncements">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($announcements as $key => $announcement)
                            <tr data-entry-id="{{ $announcement->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $announcement->is_published ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-createdByAnnouncements:not(.ajaxTable)').DataTable({ buttons: dtButtons })
