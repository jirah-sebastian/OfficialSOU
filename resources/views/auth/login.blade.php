                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        @if(Route::has('password.request'))
                                            <a class="btn btn-link px-0 text-decoration-none text-success" href="{{ route('password.request') }}">
                                                {{ trans('global.forgot_password') }}
                                            </a><br>
                                        @endif
                                        <a class="btn btn-link px-0 text-decoration-none text-success" href="{{ route('register') }}">
