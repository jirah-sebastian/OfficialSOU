...
<head>
    ...
    <title>
        @if (Request::routeIs('admin.users.index'))
            USERS
        @elseif(Request::routeIs('admin.so-lists.index'))
            STUDENT ORGANIZATIONS
        @elseif(Request::routeIs('admin.activities.index'))
            ACTIVITIES
        @elseif(Request::routeIs('admin.announcements.index'))
            ANNOUNCEMENTS
        @elseif(Request::routeIs('admin.resources.index'))
            RESOURCES
        @elseif(Request::routeIs('admin.so-categories.index'))
            SO CATEGORIES
        @elseif(Request::routeIs('admin.so-registrations.index'))
            MEMBERS
        @elseif(Request::routeIs('admin.abouts.index'))
            ABOUT
        @else
...
<body class="control-sidebar-slide-open layout-navbar-fixed sidebar-mini layout-fixed accent-success"
    style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-light bg" style="background-color: #005600;">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
